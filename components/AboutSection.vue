            ...
            <div data-aos="flip-left" class="card-b">
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  ...
                  <a href="https://github.com/RasyifIbnu" class="text-secondary" target="_blank">RasyifIbnu</a>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  ...
                  <a href="https://www.instagram.com/rasyif_ibnu?igsh=a3V2YWpnYzBkeGpq" class="text-secondary" target="_blank">rasyif_ibnu</a>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">
          ...
          <div class="col-md-8">
            <div data-aos="fade-up" class="card mb-3">
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-3">
                    <h6 class="mb-0"><i class="fas fa-user-circle mr-2"></i>Full Name</h6>
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <h6 class="mb-0"><i class="fas fa-map-marker-alt mr-2"></i>Address</h6>
                  </div>
                  <div class="col-sm-9 text-secondary">
